...
namespace SysBot.Pokemon.Dodo
{
    public class DodoBot<T> where T : PKM, new()
    {
        ...
        public void StartDistribution()
        {
            ...
            SendChannelMessage("宝可梦想佳派送机器人启动", channelId);
        ...
        public static void SendPersonalMessage(string dodoId, string message, string islandSourceId = "")
        {
            ...
            {
                islandSourceId =
                    OpenApiService.GetIslandList(new GetIslandListInput()).FirstOrDefault()?.IslandSourceId ?? "";
            }
        ...
        /**
         * Reference:https://github.com/Haisyer/TransFireBot
         * Send a picture message to the channel
         */
        ...
        /**
         * Reference:  https://github.com/Haisyer/TransFireBot
         * Send a picture message to the personal chat
         */
        ...
        public static void SendChannelCardMessage(string message, string channelId, string pokeurl, string itemurl,
            string ballurl, string teraurl, string teraoriginalurl, string shinyurl, string movetypeurl1,
            string movetypeurl2, string movetypeurl3, string movetypeurl4)
        {
            string mes = "";
        ...
        public static void SendChannelEggCardMessage(string title, string message, string channelId, string pokeurl,
            string ballurl, string shinyurl, string shinyinfo)
        {
            string mes = "";
            if (string.IsNullOrEmpty(message)) message = "None";
                            ...
                            new
                            {
                                ...
                                elements = new List<object>()
                                {
                                    ...
                                    new
                                    {
                                        type = "image",
                                        src =
                                            "https://img.imdodo.com/openapitest/upload/cdn/E714716E359055F4AD802BD414A97AF2_1696061162810.png"
                                    },
                                    new
                                    {
                                        type = "dodo-md",
        ...
        public static void SendChannelCardBatchMessage(string message, string channelId, string pokeurl, string itemurl,
            string ballurl, string shinyurl)
        {
            OpenApiService.SetChannelMessageSend(new SetChannelMessageSendInput<MessageBodyCard>
            {
                ChannelId = channelId,
